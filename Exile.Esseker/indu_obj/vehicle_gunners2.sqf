...
_marker = createMarker ["watch2", [9837.17,5716.62,0]];

_inf = "MNP_RO3_Soldier_F" createUnit [getPos _veh1, indgroup, "test2 = this"];
...
test2 assignAsGunner _veh1;
test2 moveInGunner _veh1;

test2 doWatch getMarkerPos "watch2";
