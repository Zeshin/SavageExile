...
_marker = createMarker ["watch3", [8575.43,5727.9,0]];

_inf = "MNP_RO3_Soldier_F" createUnit [getPos _veh1, indgroup, "test3 = this"];
...
test3 assignAsGunner _veh1;
test3 moveInGunner _veh1;

test3 doWatch getMarkerPos "watch3";
