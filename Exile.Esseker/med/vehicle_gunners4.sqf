...
_marker = createMarker ["watch4", [8711.06,5676.73,0]];

_inf = "MNP_RO3_Soldier_F" createUnit [getPos _veh1, blugroup2, "test4 = this"];
...
test4 assignAsGunner _veh1;
test4 moveInGunner _veh1;

test4 doWatch getMarkerPos "watch4";